...
#define ManAPIProgramBuild 1260
...
enum
{
  MONTHLY_STATEMENT_END_MONTH,
  MONTHLY_STATEMENT_START_MONTH
};
//--- server stop reason
enum
{
...
enum
{
  ...
  MARGIN_CALC_CFD,
  MARGIN_CALC_FUTURES,
  MARGIN_CALC_CFDINDEX,
  MARGIN_CALC_CFDLEVERAGE
};
//--- GTC mode
enum
{
